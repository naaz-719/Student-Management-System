                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <a href='edit_student.php?enrollment_no=" . urlencode($row['enrollment_no']) . "' class='btn btn-warning btn-sm'>Edit</a>
                                    <a href='delete_student.php?enrollment_no=" . urlencode($row['enrollment_no']) . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure you want to delete this student?');\">Delete</a>
                                </td>
                              </tr>";
                    }
                } else {
